...
- (void)setModel:(YLDepreciateModel *)model {
    ...
    self.downF = CGRectMake(CGRectGetMaxX(self.priceF), CGRectGetMaxY(self.courseF) + 9, 16, 16);
    self.depreciateF = CGRectMake(CGRectGetMaxX(self.downF) + 5, CGRectGetMaxY(self.courseF) + 9, YLScreenWidth - CGRectGetMaxX(self.downF) - YLTopSpace, 17);
