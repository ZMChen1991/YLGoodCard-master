//
//  YLSubCancelBuyOrderController.m
//  YLGoodCard
//
...
@interface YLSubCancelBuyOrderController ()
@property (nonatomic, strong) NSMutableArray *buyOrders;
@end

@implementation YLSubCancelBuyOrderController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadData {
    ...
    [YLRequest GET:urlString parameters:param success:^(id  _Nonnull responseObject) {
        ...
        if ([responseObject[@"code"] isEqualToNumber:[NSNumber numberWithInteger:200]]) {
            [self keyedArchiverObject:responseObject toFile:YLCancelBuyOrderPath];
            [self getLocalData];
