...
- (void)setIsLargeImage:(BOOL)isLargeImage {
    ...
    CGFloat priceW = [[self stringToNumber:self.model.price] getSizeWithFont:[UIFont systemFontOfSize:18]].width + 10;
    if (isLargeImage) {
        ...
        self.priceF = CGRectMake(YLLeftSpace, CGRectGetMaxY(self.courseF) + 5, priceW, 25);
